...
colors = plt.cm.jet(np.linspace(0, 1, len(unique_owners)))
...
axis_layout = dict(showbackground=False, showline=False, zeroline=False, showgrid=False, showticklabels=False, title='')
